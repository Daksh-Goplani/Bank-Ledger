...
const transactionSchema = new mongoose.Schema({
    ...
    amount: {
        type: Number,
        required: [true, "Amount is required for creating transaciton"],
...
const transacitonModel = mongoose.model("transaction", transactionSchema)

module.exports = transacitonModel